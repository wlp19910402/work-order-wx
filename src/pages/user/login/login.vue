<template>
  <view class="content">
    ...
    <view class="btn-row">
      <button type="primary" class="primary" :loading="loginBtnLoading" @tap="bindLogin">
        登录
      </button>
    </view>
    ...
    <view class="oauth-row" v-if="hasProvider && !hasAppleLogin" v-bind:style="{ top: positionTop - 50 + 'px' }">
      <text style="color: #C8C7CC;text-align: center;">暂无法使用苹果登录，请查阅&nbsp;&nbsp;<a style="color: #C8C7CC;"
          href="https://ask.dcloud.net.cn/article/36651">Apple登录集成教程</a></text>
    </view>
  </view>
</template>
...
<style>
    ...
    .login-type-btn.act {
        color: #24bd7a;
        border-bottom: solid 1px #24bd7a;
    }
